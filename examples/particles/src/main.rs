//! `particles` CLI — thin shim around `particles::build()`.
...
#[command(
    name = "particles",
    about = "Render the official particles example template."
)]
struct Cli {
    ...
    format: String,
    #[arg(long, default_value = "particles.png")]
    out: PathBuf,
